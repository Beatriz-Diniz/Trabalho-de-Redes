...
void broadcast_message_str(string message, int sender_id, char sender_channel[], char name[]){
...
void broadcast_message(int num, int sender_id, char sender_channel[], char name[]){
	for (int i = 0; i < clients.size(); i++){
		int helper = (clients[i].channel.compare(sender_channel));
